function bookSearch() {
    ...
    $.ajax({
        url: "https://www.googleapis.com/books/v1/volumes?q=" + title + "+inauthor:" + author + "&maxResults=1",
        dataType: "json",
...
document.getElementById('Title').addEventListener("blur", bookSearch, false);